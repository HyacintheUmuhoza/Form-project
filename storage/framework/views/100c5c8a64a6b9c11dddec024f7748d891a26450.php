...
<body>
    <div id="svg_wrap"></div>
    <form id="regForm" action="<?php echo e(route('adduser')); ?> " method="post">
        <?php echo csrf_field(); ?>
 <h1>STAFF FULL IDENTIFICATION FORM</h1>
<section class="tab">
  ...
  <input type="text" name="nameOfTheBankUsed" placeholder="NAME OF THE BANK(S) USED:">
...
<section class="tab">
  ...
  <input type="text" name="residenceVillage" placeholder="VILLAGE" />
  <input type="text" name="residenceCell" placeholder="CELL" />
  <input type="text" name="residenceSector" placeholder="SECTOR" />
  <input type="text" name="residenceDistrict" placeholder="DISTRICT" />
  <input type="text" name="residenceProvince" placeholder="PROVINCE" />
</section>
<section class="tab">
    ...
    <input type="radio" name="martialStatus" value="DEPENDANTS">DEPENDANTS
  </section>
<section class="tab">
  <p>EDUCATION LEVEL</p>
...
<section class="tab">
  ...
  <input type="radio" name="prohibitedDrugs" value="No"/> No
...
<section class="tab">
  ...
  <p>I swear that the above information is correct and sincere; if I lied in any of the above
    information, I accept to be dismissed from RIB duties and to be punished according to
    relevant laws and regulations.</p>
    <p>Done at ………………., on<span id="current_date"></span> Signature: ……………………</p>
</section>
...
</html><?php /**PATH E:\Laravel Project\Hce-project\resources\views/welcome.blade.php ENDPATH**/ ?>